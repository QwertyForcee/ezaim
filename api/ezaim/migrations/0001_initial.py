# Generated by Django 4.1.3 on 2022-12-19 10:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('csv', encrypted_model_fields.fields.EncryptedCharField()),
                ('initials', encrypted_model_fields.fields.EncryptedCharField()),
                ('valid_through', encrypted_model_fields.fields.EncryptedDateTimeField()),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ezaim.user')),
            ],
            options={
                'abstract': False,
